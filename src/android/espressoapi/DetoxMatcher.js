...
class DetoxMatcher {
  ...
  static matcherForResourceName(resourceName) {
    if (typeof resourceName !== "string") throw new Error("resourceName should be a string, but got " + (resourceName + (" (" + (typeof resourceName + ")"))));
    return {
      target: {
        type: "Class",
        value: "com.wix.detox.espresso.DetoxMatcher"
      },
      method: "matcherForResourceName",
      args: [resourceName]
    };
  }
